	  ...
	  <div class="collapse navbar-collapse" id="navbarNav">
	    <ul class="navbar-nav ml-auto">
	      <li class="nav-item active">
	        <a class="nav-link" href="/stamp/index.php">Home <span class="sr-only">(current)</span></a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/stamp/public_files/signup.php">Sign up</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="/stamp/public_files/login.php">Log in</a>
	      </li>
	      <li class="nav-item">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" href="#">About</a><!-- maybe stamp's timeline -->
	      </li>
